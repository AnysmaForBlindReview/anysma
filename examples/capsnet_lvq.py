...
def LvqCapsNet(input_shape, n_class):
    ...
    digit_caps.add(InputModule(signal_shape=8, dissimilarity_initializer='zeros'))
    ...
    digit_caps.add(Classification(probability_transformation='neg_exp', name='lvq_caps'))
